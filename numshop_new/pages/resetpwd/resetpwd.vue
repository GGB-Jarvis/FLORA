	...
	<view>
		<view class="main">
			...
			<view class="form">
				...
				<input placeholder="请输入验证码" placeholder-class="placeholder-class" v-model="code">
				<input password="true" placeholder="请输入密码" placeholder-class="placeholder-class" v-model="password">
				<input password="true" placeholder="请确认密码" placeholder-class="placeholder-class" v-model="password2">
				<view class="button" @tap="reset" role="button">
					<span>重置密码</span>
				</view>
	...
	export default {
		...
		methods: {
			...
			sendCode(){
				...
				var that = this;
				this.$api.sendCode2({phone:phone}).then(resp=>{
					if(resp.code){
